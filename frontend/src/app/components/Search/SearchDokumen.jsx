...
const SearchDokumen = () => {
  ...
  const sortedResults = results.filter((result) => result.type === "dokumen").sort((a, b) => a.score - b.score); // Sorting by score in descending order
